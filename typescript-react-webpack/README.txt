...
0. > cd <your path>/typescript-react-webpack
...
5. > cd <your path>/typescript-react-webpack
...
8. Navigate to localhost:8082 in your browser. 

Note: Development on this project will be much easier using Visual Studio Code, which understands TypeScript
